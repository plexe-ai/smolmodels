    ...
    class _CodeGenerationConfig:
        ...
        prompt_inference_preprocessing: Template = field(
            default=Template(
                ...
                "${training_code}\n"
                "```\n\n"
                "Generate Python code to preprocess a single input sample before prediction. The code should:\n"
                "1. Take a dictionary matching the input schema\n"
                "2. Apply the same preprocessing steps used during training\n"
                "3. Return the preprocessed data in the format expected by the model\n\n"
                "Only include preprocessing logic, assume model loading is already done."
            )
        )
        prompt_inference_prediction: Template = field(
            default=Template(
                "Given this output schema and training code:\n\n"
                "Output Schema:\n"
                "```python\n"
                "${output_schema}\n"
                "```\n\n"
                ...
                "1. Take preprocessed input data\n"
        ...
        prompt_inference_combine: Template = field(
            default=Template(
                ...
                "2. Have a predict() function that takes a dictionary and returns a dictionary\n"
