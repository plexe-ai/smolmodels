    ...
    class _CodeGenerationConfig:
        ...
        prompt_training_generate: Template = field(
            default=Template(
                ...
                "and save all model files directly in the current directory with descriptive names (e.g., 'preprocessor.joblib', 'model.joblib', etc.). "
        ...
        prompt_training_fix: Template = field(
            default=Template(
                ...
                "directly in the current directory with descriptive names (e.g., 'preprocessor.joblib', 'model.joblib', etc.). "
