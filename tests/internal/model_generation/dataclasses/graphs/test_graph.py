...
from smolmodels.internal.model_generation.dataclasses.graphs.graph import Graph
from smolmodels.internal.model_generation.dataclasses.graphs.node import Node
