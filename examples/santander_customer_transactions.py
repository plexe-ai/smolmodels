...
This dataset is not part of the smolmodels package or in any way affiliated to it, and Plexe AI claims no rights over it.
...
# NOTE: this dataset has over 200 columns, so we leave input schema empty and let smolmodels infer it automatically
model = sm.Model(
    intent=(
...
sm.save_model(model, "santander_transactions_model.tar.gz")
